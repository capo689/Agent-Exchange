...
const staticAssets = Object.freeze({
  ...
  '/dashboard/': { path: '../public/dashboard.html', type: 'text/html; charset=utf-8' },
  '/dashboard/dashboard.css': { path: '../public/dashboard.css', type: 'text/css; charset=utf-8' },
  '/dashboard/dashboard.js': { path: '../public/dashboard.js', type: 'application/javascript; charset=utf-8' },
  ...
  '/assets/launch/agent-confetti.svg': { path: '../public/assets/launch/agent-confetti.svg', type: 'image/svg+xml; charset=utf-8' },
